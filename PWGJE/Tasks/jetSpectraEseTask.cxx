...
struct JetSpectraEseTask {
  ...
  OutputObj<JetEseContainer> fJet{JetEseContainer{"jetContainer"}};
  ...
  using ColESE = soa::Join<aod::Collisions, aod::CentFT0Cs, aod::QVecFT0Cs, aod::QPercentileFT0Cs, aod::FEseCols, aod::BkgChargedRhos>;
